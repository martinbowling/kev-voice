...
// between utterances while the local model and Mac actions run independently.
...
final class SpeechEngine {
    ...
    func start(hints: [String]) throws {
        ...
        self.hints = Array((hints + ["Kev", "end command", "cancel task", "stop listening"]).prefix(100))
    ...
    func replay(_ url: URL, finished: @escaping () -> Void) throws {
        ...
        hints = ["Kev", "Notes", "Arc", "Chrome", "Photo Booth"]
